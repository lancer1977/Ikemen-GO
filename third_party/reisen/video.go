...
func (video *VideoStream) buildFilterGraphFromFrame(f *C.AVFrame) error {
	...
	// Keep this source-compatible with Ubuntu/Mint FFmpeg 6.1 headers. Newer
	// FFmpeg exposes color_space/color_range on AVBufferSrcParameters, but 6.1
	// does not. The buffer source still accepts the required dimensions, format,
