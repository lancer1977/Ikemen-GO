...
- [ ] Prove the restored Android artifact lane on `develop` through GitHub Actions
- [ ] Prove at least one desktop artifact lane in the same non-publishing diagnostic run
